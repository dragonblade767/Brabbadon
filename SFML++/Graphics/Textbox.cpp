...
std::string Textbox::stars(std::string password)
{
    std::string stars;
...
void Textbox::typing(char letter)
{
...
bool Textbox::mouseClick(sf::RenderWindow &window)
{
